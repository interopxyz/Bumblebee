...
{
    public class GH_Ex_Shp_FlowChart : GH_Ex_Shp__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Sh_FlowChart class.
        /// </summary>
        public GH_Ex_Shp_FlowChart()
          : base("XL Flow Chart", "Flow",
              "Adds a Flow Chart object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (ShapeFlowChart value in Enum.GetValues(typeof(ShapeFlowChart)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Rectangle3d rect = GetBoundary(200, 100, 50, 50);
            ...
            if (activate) DA.SetData(1, worksheet.AddShape(name, (ShapeFlowChart)type, rect));
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Shape_Flow_01;
            }
        }
        ...
        {
            get { return new Guid("3d170abd-2cc6-4110-97f3-4066dee2fcc1"); }
        }
    }
}