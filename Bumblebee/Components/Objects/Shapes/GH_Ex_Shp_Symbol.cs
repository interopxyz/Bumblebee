...
{
    public class GH_Ex_Shp_Symbol : GH_Ex_Shp__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Sh_Symbol class.
        /// </summary>
        public GH_Ex_Shp_Symbol()
          : base("XL Symbol", "Symbol",
              "Adds a Symbol Shape object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (ShapeSymbol value in Enum.GetValues(typeof(ShapeSymbol)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Rectangle3d rect = GetBoundary(350, 100, 50, 50);
            ...
            if (activate) DA.SetData(1, worksheet.AddShape(name, (ShapeSymbol)type, rect));
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Shape_Math_01;
            }
        }
        ...
        {
            get { return new Guid("e428b0f0-24fc-4be2-975d-c62c69f581e3"); }
        }
    }
}