...
{
    public class GH_Ex_Shp_Geometry : GH_Ex_Shp__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Sh_Geometry class.
        /// </summary>
        public GH_Ex_Shp_Geometry()
          : base("XL Geometry", "Geo",
              "Adds a Geometry Shape object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (ShapeGeometry value in Enum.GetValues(typeof(ShapeGeometry)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Rectangle3d rect = GetBoundary(250, 100, 50, 50);
            ...
            if (activate) DA.SetData(1, worksheet.AddShape(name, (ShapeGeometry)type, rect));
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Shape_Geometry_01;
            }
        }
        ...
        {
            get { return new Guid("c893200a-49a3-4e52-9db7-905e251816d1"); }
        }
    }
}