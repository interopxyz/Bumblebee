...
{
    public class GH_Ex_Shp_Arrow : GH_Ex_Shp__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Sh_Arrow class.
        /// </summary>
        public GH_Ex_Shp_Arrow()
          : base("XL Arrow", "Arrow",
              "Adds a Arrow Shape object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (ShapeArrow value in Enum.GetValues(typeof(ShapeArrow)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Rectangle3d rect = GetBoundary(100, 100, 50, 50);
            ...
            if (activate) DA.SetData(1, worksheet.AddShape(name, (ShapeArrow)type, rect));
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Shape_Arrow_01;
            }
        }
        ...
        {
            get { return new Guid("b0133507-c940-42de-a176-1129b17cff38"); }
        }
    }
}