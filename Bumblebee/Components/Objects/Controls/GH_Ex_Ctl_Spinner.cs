...
{
    public class GH_Ex_Ctl_Spinner : GH_Ex_Ctl__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Ct_Spinner class.
        /// </summary>
        public GH_Ex_Ctl_Spinner()
          : base("XL Spinner", "Spinner",
              "Adds a Spinner Control Shape object",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Rectangle3d boundary = GetBoundary(10, 225, 15, 20);
            ...
            if (activate) DA.SetData(1, worksheet.AddSpinner(name, cell, domain, increment, boundary));
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Controls_Spinner_01;
            }
        }
        ...
        {
            get { return new Guid("c82748ae-c1fb-4559-81a9-22f060c2e986"); }
        }
    }
}