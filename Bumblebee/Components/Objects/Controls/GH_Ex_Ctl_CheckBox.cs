...
{
    public class GH_Ex_Ctl_CheckBox : GH_Ex_Ctl__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Ct_CheckBox class.
        /// </summary>
        public GH_Ex_Ctl_CheckBox()
          : base("XL Check Box", "CheckBox",
              "Adds a Check Box Control Shape object",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (activate) DA.SetData(1, worksheet.AddCheckBox(name, title, cell, boundary));
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Controls_Check_01;
            }
        }
        ...
        {
            get { return new Guid("87fa29ee-7a30-4287-aeb7-14f724a7bc64"); }
        }
    }
}