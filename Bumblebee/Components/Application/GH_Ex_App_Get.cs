...
{
    public class GH_Ex_App_Get : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_App class.
        /// </summary>
        public GH_Ex_App_Get()
          : base("Excel Application", "XL App",
              "Gets an active Excel Application or opens a new one",
        ...
        {
            pManager.AddGenericParameter(Constants.App.Name, Constants.App.NickName, Constants.App.Output, GH_ParamAccess.item);
        }
