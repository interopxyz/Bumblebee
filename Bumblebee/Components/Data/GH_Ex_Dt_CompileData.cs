...
{
    public class GH_Ex_Dt_CompileData : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Dt_CompileData class.
        /// </summary>
        public GH_Ex_Dt_CompileData()
          : base("Compile Data", "Compile Data",
              "Compile data into column and row assemblies",
        ...
        {
            pManager.AddTextParameter("Column Names", "C", "The names of the columns", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (hasFormat)
            {
                data = new ExData(columns,values,formats);
            }
            else
            {
                data = new ExData(columns, values);
            }
