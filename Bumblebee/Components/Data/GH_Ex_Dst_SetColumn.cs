...
{
    public class GH_Ex_Dst_SetColumn : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Dt_Column class.
        /// </summary>
        public GH_Ex_Dst_SetColumn()
          : base("Compile Column", "Col",
              "Compile data into a Column assembly",
        ...
        {
            pManager.AddGenericParameter(Constants.DataSet.Name, Constants.DataSet.NickName, Constants.DataSet.Input, GH_ParamAccess.item);
        }
