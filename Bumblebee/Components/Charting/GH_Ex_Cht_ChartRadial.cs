...
{
    public class GH_Ex_Cht_ChartRadial : GH_Ex_Cht__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Ch_ChartRad class.
        /// </summary>
        public GH_Ex_Cht_ChartRadial()
          : base("Radial Chart", "Rad Chart",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (RadialChartType value in Enum.GetValues(typeof(RadialChartType)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (activate)
            {
                ...
                chart.SetRadialChart((RadialChartType)type);
                DA.SetData(1, chart);
            }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Chart_Radial_01;
            }
        }
        ...
        {
            get { return new Guid("ad31a23b-a5af-40cf-8b79-0f2351660d31"); }
        }
    }
}