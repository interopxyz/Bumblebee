...
{
    public class GH_Ex_Cht_Column : GH_Ex_Cht__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Ex_Ch_Column class.
        /// </summary>
        public GH_Ex_Cht_Column()
          : base("Column Chart", "Col Chart",
              "Add a Column Chart object",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (activate)
            {
                ...
                chart.SetColumnChart((BarChartType)type, (ChartFill)fill);
                DA.SetData(1, chart);
            }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.BB_Chart_Column_01;
            }
        }
        ...
        {
            get { return new Guid("dde6297e-0e49-4428-9426-ac7d9d93e1f0"); }
        }
    }
}